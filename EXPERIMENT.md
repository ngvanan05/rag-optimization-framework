...
**English · [Tiếng Việt](EXPERIMENT.vi.md)**
...
> **Bold** = best score per metric (tied values are all bolded).
...
Detailed charts per variant (exported from `run_eval.py`):
...
![RAGAS score comparison table — all variants](https://raw.githubusercontent.com/ngvanan05/rag-optimization-framework/main/outputs/images/comparison_report_page-0001.jpg)

![Bar chart across 4 metrics](https://raw.githubusercontent.com/ngvanan05/rag-optimization-framework/main/outputs/images/comparison_report_page-0002.jpg)
