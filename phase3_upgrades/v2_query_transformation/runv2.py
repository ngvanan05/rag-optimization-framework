...
Replaces SearchEngine + RAGChain with DecompositionBatchRAG.
...
from phase3_upgrades.v2_query_transformation.query_decomposer import DecompositionBatchRAG

OUTPUT_PATH = ROOT / "outputs" / "phase3_upgrades" / "v2_query_decomposition.csv"

def main():
    set_global_seed(SEED)
    print("=" * 55)
    print("  PHASE 3 - v2: QUERY DECOMPOSITION")
    print("=" * 55)
    ...
    print("\n[4/4] Running inference with Query Decomposition...")
    ...
    generator = DecompositionBatchRAG(llm, batch_size=BATCH_SIZE)
